...
{
    if (argc != 9){
        printf("Error: must receive 8 parameters - <text to print> <output path> <fonts directory> <font family> <font weight index 0-5> <font stretch 0-8> <letter spacing 0-3> <font size 0-3>");
